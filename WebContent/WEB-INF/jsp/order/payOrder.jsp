...
<script type="text/html" id="barDemo">
    <a class="layui-btn layui-btn-xs" lay-event="edit">申请退房结账</a>
    ...
    layui.use(
        ...
        function(){
            ...
            table.render({
                elem: '#demo'
                ,height: 530
                ,url: '${ctxPath}/order/select/status?status=入住&ran='+ ran //数据接口
                ,title: '入住表'
...
<script>
    ...
    function reloadPage(){
        window.location = '${ctxPath}/order/payOrder';
    }
